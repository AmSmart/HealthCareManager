...
namespace HealthCareManager.Server.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalInformation = table.Column<Dictionary<string, string>>(type: "jsonb", nullable: false),
                    MedicalHistory = table.Column<List<MedicalEvent>>(type: "jsonb", nullable: false)
                },
                constraints: table =>
                {
